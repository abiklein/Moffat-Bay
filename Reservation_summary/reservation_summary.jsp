...
<%
 ...
 java.sql.Date sqlcheckInDate = new java.sql.Date(checkIn.getTime());

 java.util.Date checkOut = sdf.parse(checkOutDate);
 java.sql.Date sqlcheckOutDate = new java.sql.Date(checkOut.getTime());
 
  
  
//Get time in milliseconds
 long checkInMillis = checkOut.getTime(); 
 long checkOutMillis = checkIn.getTime();
...
<input id ="cancel" name="cancel" type="submit" value="Cancel"><br/><br/><br/><br/>
