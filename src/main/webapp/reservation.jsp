...
<body>
    ...
    <div class="reservation_form">
        ...
        <form id="reservation" action="reservation_summary.jsp" method="post">
            ...
            <select id="room_size_id" name="roomSize" required>
                <option value="Double Full Beds">
                	Double Full Beds
                </option>
                <option value="Queen Bed">
                	Queen Bed
                </option>
                <option value="Double Queen Beds">
                	Double Queen Beds
                </option>
            ...
            <div class="guests">
                ...
                <input type='number' id="numGuests" name='numGuests' placeholder="Number of Guests" required />
            ...
            <input type="submit" name="submit" value="Submit" formaction="reservation_summary.jsp">
        </form>
    </div>
